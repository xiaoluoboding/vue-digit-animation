/*!
  * vue-digit-wheel v0.1.6
  * (c) 2020 xiaoluoboding
  * @license MIT
  */
var VueDigitWheel = (function (exports, vue) {
	'use strict';
	...
	const _withId = /*#__PURE__*/vue.withScopeId("data-v-adefeb32");
	  ...
	  return (vue.openBlock(), vue.createBlock("div", {
	    ...
	    (_ctx.isDigit(_ctx.digit))
	      ? (vue.openBlock(), vue.createBlock("div", {
	          ...
	          (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.digitWheel, (item) => {
	            return (vue.openBlock(), vue.createBlock("div", {
	              class: "digit is-digit",
	              key: item.value,
	              "data-digit": item.value,
	              style: item.style
	            }, vue.toDisplayString(item.value), 13 /* TEXT, STYLE, PROPS */, ["data-digit"]))
	          }), 128 /* KEYED_FRAGMENT */))
	        ], 12 /* STYLE, PROPS */, ["id", "data-digit"]))
	      : (vue.openBlock(), vue.createBlock("div", {
	          key: 1,
	          class: ["digit", _ctx.ensureDigitClass(_ctx.digit)]
	        }, vue.toDisplayString(_ctx.digit), 3 /* TEXT, CLASS */))
	  ], 4 /* STYLE */))
	});
	...
	var script$1 = vue.defineComponent({
	    ...
	    setup(props) {
	        const groupDigits = vue.computed(() => {
	...
	const _withId$1 = /*#__PURE__*/vue.withScopeId("data-v-3b84a308");

	const render$1 = /*#__PURE__*/_withId$1(function render(_ctx, _cache, $props, $setup, $data, $options) {
	  const _component_DigitWheel = vue.resolveComponent("DigitWheel");

	  return (vue.openBlock(), vue.createBlock("div", {
	    class: "digit-wheel-group",
	    style: _ctx.textStyle
	  }, [
	    (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.groupDigits, (digit, index) => {
	      return (vue.openBlock(), vue.createBlock("div", {
	        class: "digit-wheel-group__col",
	        style: _ctx.colStyle,
	        key: index
	      }, [
	        vue.createVNode(_component_DigitWheel, vue.mergeProps({
	          "is-group": "",
	          digit: digit,
	          index: index,
	          size: _ctx.size
