/*!
  ...
  * @license MIT
  */
var DigitalGyro = (function (exports, vue) {
	'use strict';
	  ...
	  return (vue.openBlock(), vue.createBlock("div", {
	    ...
	    (_ctx.isDigit(_ctx.value))
	      ...
	      : (vue.openBlock(), vue.createBlock("div", {
	        ...
	        }, vue.toDisplayString(_ctx.value), 3 /* TEXT, CLASS */))
	  ], 4 /* STYLE */))
	});
	...
	const _withId$1 = /*#__PURE__*/vue.withScopeId("data-v-57331f7e");
	...
	const render$1 = /*#__PURE__*/_withId$1(function render(_ctx, _cache, $props, $setup, $data, $options) {
	  ...
	  return (vue.openBlock(), vue.createBlock("div", {
	    ...
	    (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.digits, (digit, index) => {
	      return (vue.openBlock(), vue.createBlock("div", {
